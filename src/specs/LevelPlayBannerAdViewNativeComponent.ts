...
interface NativeCommands {
   ...
   */
  loadAd(viewRef: React.ElementRef<LevelPlayBannerAdViewNativeComponentType>): void;
   ...
   * @param viewRef - Reference to the banner ad view.
   */
  destroy(viewRef: React.ElementRef<LevelPlayBannerAdViewNativeComponentType>): void;
   ...
   * @param viewRef - Reference to the banner ad view.
   */
  pauseAutoRefresh(viewRef: React.ElementRef<LevelPlayBannerAdViewNativeComponentType>): void;
   ...
   * @param viewRef - Reference to the banner ad view.
   */
  resumeAutoRefresh(viewRef: React.ElementRef<LevelPlayBannerAdViewNativeComponentType>): void;
}
...
export default codegenNativeComponent<NativeProps>('LevelPlayBannerAdView') as HostComponent<NativeProps>;
