import { LevelPlayAdSize, type AdInfo, type IronSourceError, type LevelPlayAdError, type LevelPlayAdInfo, type LevelPlayConfiguration, type LevelPlayInitError, type LevelPlayReward, type LevelPlayImpressionData, LevelPlayNativeAd } from "../models";
...
export const levelPlayNativeAdFromMap = (data: any, originalAd: LevelPlayNativeAd): LevelPlayNativeAd => {
