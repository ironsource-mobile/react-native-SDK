...
const {
  IronSourceMediation
} = _reactNative.NativeModules; // Event Name Constants defined on iOS platform
...
const eventEmitter = new _reactNative.NativeEventEmitter(IronSourceMediation); // Stub out for Android
...
exports.ConsentViewEvents = ConsentViewEvents;
