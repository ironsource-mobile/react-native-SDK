...
var React = _react;
var _LevelPlayNativeAdComponent = require("./LevelPlayNativeAdComponent");
...
function LevelPlayNativeAdView(props) {
  ...
  (0, _react.useEffect)(() => {
    ...
    const component = (0, _LevelPlayNativeAdComponent.LevelPlayNativeAdComponent)(viewType || 'levelPlayNativeAdViewType');
