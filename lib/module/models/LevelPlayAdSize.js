import { BANNER_WIDTH, BANNER_HEIGHT, SIZE_BANNER_LABEL, LARGE_WIDTH, LARGE_HEIGHT, SIZE_LARGE_LABEL, MEDIUM_RECTANGLE_WIDTH, MEDIUM_RECTANGLE_HEIGHT, SIZE_MEDIUM_RECTANGLE_LABEL, SIZE_CUSTOM_LABEL } from '../utils/LevelPlayConstants';
...
export class LevelPlayAdSize {
  ...
  static async createAdaptiveAdSize(width = null) {
    const sizeMap = width != null ? await NativeLevelPlayMediation.createAdaptiveAdSizeWithWidth(width) : await NativeLevelPlayMediation.createAdaptiveAdSize();
