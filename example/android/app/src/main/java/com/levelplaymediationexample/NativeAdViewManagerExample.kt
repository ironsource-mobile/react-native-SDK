...
import com.unity3d.reactnative.R
import com.unity3d.reactnative.LevelPlayNativeAdViewManager

class NativeAdViewManagerExample(
  reactApplicationContext: ReactApplicationContext,
  layoutId: Int
): LevelPlayNativeAdViewManager(reactApplicationContext, layoutId) {
